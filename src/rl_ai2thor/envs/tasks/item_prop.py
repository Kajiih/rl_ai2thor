...
from rl_ai2thor.envs.sim_objects import SimObjFixedProp, SimObjProp, SimObjVariableProp
from rl_ai2thor.envs.tasks._item_prop_complex import (
    IsCookedProp,
...
from rl_ai2thor.envs.tasks.item_prop_interface import ItemProp
