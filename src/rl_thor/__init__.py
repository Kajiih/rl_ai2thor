...
register(
    id="rl_thor/ITHOREnv-v0.1",
    entry_point="rl_thor.envs.ai2thor_envs:ITHOREnv",
...
NormalizeActionWrapper_spec = WrapperSpec(
    ...
    entry_point="rl_thor.envs.wrappers:NormalizeActionWrapper",
    kwargs={},
)

register(
    id="rl_thor/ITHOREnv-v0.1_sb3_ready",
    entry_point="rl_thor.envs.ai2thor_envs:ITHOREnv",
    additional_wrappers=(
        # WrapperSpec(
        ...
        WrapperSpec(
            ...
            entry_point="rl_thor.envs.wrappers:ChannelFirstObservationWrapper",
            kwargs={},
        ),
    ),
)
